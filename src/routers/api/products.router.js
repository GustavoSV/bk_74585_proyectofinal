...
class ProductsRouter extends RouterHelper {
  ...
  init = () => {
    this.postMeth("/", ["ADMIN"], createOne);
    this.getMeth("/", ["PUBLIC"], readAll);
    this.getMeth("/:id", ["PUBLIC"], readById);
    this.putMeth("/:id", ["ADMIN"], updateById);
    this.deleteMeth("/:id", ["ADMIN"], destroyById);
  };
}
